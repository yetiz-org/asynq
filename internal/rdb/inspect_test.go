...
func TestAllQueues(t *testing.T) {
	...
	for _, tc := range tests {
		...
		for _, qname := range tc.queues {
			if err := r.client.SAdd(context.Background(), base.AllQueuesKey(""), qname).Err(); err != nil {
...
func TestCurrentStats(t *testing.T) {
	...
	for _, tc := range tests {
		...
		h.SeedRedisSet(t, r.client, base.AllQueuesKey(""), tc.allQueues)
...
func TestHistoricalStats(t *testing.T) {
	...
	for _, tc := range tests {
		...
		r.client.SAdd(context.Background(), base.AllQueuesKey(""), tc.qname)
...
func TestListAggregating(t *testing.T) {
	...
	for _, tc := range tests {
		h.FlushDB(t, r.client)
		h.SeedRedisSet(t, r.client, base.AllQueuesKey(""), fxt.allQueues)
...
func TestRemoveQueue(t *testing.T) {
	...
	for _, tc := range tests {
		...
		if r.client.SIsMember(context.Background(), base.AllQueuesKey(""), tc.qname).Val() {
			t.Errorf("%q is a member of %q", tc.qname, base.AllQueuesKey(""))
		}
